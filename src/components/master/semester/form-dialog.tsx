                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                name="semester"
                                type="text"
                                placeholder="Contoh: Ganjil / 1"
                                defaultValue={dataToEdit?.semester}
                                required
                                className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm border-input bg-transparent placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                            />
                        </div>
